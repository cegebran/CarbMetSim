...
class Kidney {
    ...
    processTick() {
        ...
        var glucoseExcretionRate__ = poissonProcess.sample(1000.0 * this.glucoseExcretionRate_)/1000;
        
        var glycolysisMin__ = poissonProcess.sample(1000.0 * this.glycolysisMin_)/1000;
        
        var gngRate__ = poissonProcess.sample(1000.0 * this.gluconeogenesisRate_)/1000;
        
        var gngFromLactateRate__ = poissonProcess.sample(1000.0 * this.gngFromLactateRate_)/1000;
        
        var Glut2VMax__ = poissonProcess.sample(1000.0 * this.Glut2VMAX_)/1000;
        
        var basalAbsorption__ = poissonProcess.sample(1000.0 * this.Glut1Rate_)/1000;
