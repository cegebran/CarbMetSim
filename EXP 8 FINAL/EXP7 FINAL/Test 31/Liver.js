...
class Liver {
    ...
    processTick() {
        ...
        var glycogenToGlucose__ = poissonProcess.sample(1000.0 * this.glycogenToGlucose_)/1000;
        
        var glucoseToGlycogen__ = poissonProcess.sample(1000.0 * this.glucoseToGlycogen_)/1000;
