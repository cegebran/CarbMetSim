...
void Stomach::processTick()
{
	...
	//Chyme leakage does #include <iostream>
#include <math.h>
#include "Stomach.h"
#include "Intestine.h"
#include "AdiposeTissue.h"
...
not change the relative fraction of carbs/fats/proteins in the chyme left in the stomach. 
    ...
    var glyolysisMin__ = new PoissonDistribution = 
