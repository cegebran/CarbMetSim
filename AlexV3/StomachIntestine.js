...
StomachIntestine.Enterocytes = class {   
	    ...
	    absorbGlucose(glucoseInLumen, body) {
	        ...
	        x = body.bodyWeight_;
	        /////////////////////////////////////////////////////////////////////// 
	        var basalAbsorption__  = new PoissonDistribution(this.sglt1Rate_);
	        var Glut2VMAX_In__ = new PoissonDistribution(this.Glut2VMAX_In_);
	        var Glut2VMAX_Out__ = new PoissonDistribution(this.Glut2VMAX_Out_);
	        ...
	        if( glucoseInLumen > 0 ) {
	            ...
	            activeAbsorption = basalAbsorption__.sample();
	            ...
	            if( activeAbsorption >= glucoseInLumen ) {
	                ...
	                glEnterocytes = glucose/this.fluidVolumeInEnterocytes_;
	                ...
	                if( diff > 0 ) {
	                    ...
	                    x = this.Glut2VMAX_In__.sample();
	                    var effectiveVmax = x*glLumen/peakGlucoseConcentrationInLumen;
	     ...
	     // log all the concentrations (in mmol/l)
	        ...
	        glEnterocytes = (10.0/180.1559)*glucose/this.fluidVolumeInEnterocytes_;
