...
class Blood{
    ...
    updateRBCs() {
    	...
    	this.bin0--;
        if(this.bin0 < 0 ) 
            this.bin0 = this.MAXAGE;
        
        //New RBCs take birth
        AgeBins[this.bin0].RBCs = rbcBirthRate_;
        AgeBins[this.bin0].glycatedRBCs = 0;
        
        //System.out.println("New RBCs: " + AgeBins[bin0].RBCs);
        // Old (100 to 120 days old) RBCs die
        var start_bin = this.bin0 + this.HUNDREDDAYS;
    ...
    processTick() {
	  ...
	  //calculating average bgl during a day
        ...
        SimCtlObject.time_stamp();
        console.log("Blood:: insulin " + this.insulin);
